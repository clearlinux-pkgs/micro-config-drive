...
Version  : 40
Release  : 27
URL      : https://github.com/clearlinux/micro-config-drive/releases/download/v40/micro-config-drive-40.tar.xz
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v40/micro-config-drive-40.tar.xz
...
%prep
%setup -q -n micro-config-drive-40
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571164443
...
cp %{_builddir}/micro-config-drive-40/COPYING %{buildroot}/usr/share/package-licenses/micro-config-drive/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/micro-config-drive-40/LICENSE %{buildroot}/usr/share/package-licenses/micro-config-drive/b5e5f8134b8651d53d5804bb982b9eb4217611c4
%make_install
