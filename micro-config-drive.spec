...
Version  : 39
Release  : 26
URL      : https://github.com/clearlinux/micro-config-drive/releases/download/v39/micro-config-drive-39.tar.xz
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v39/micro-config-drive-39.tar.xz
...
%prep
%setup -q -n micro-config-drive-39
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569876954
