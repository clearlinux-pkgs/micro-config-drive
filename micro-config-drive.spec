...
Version  : 38
Release  : 25
URL      : https://github.com/clearlinux/micro-config-drive/releases/download/v38/micro-config-drive-38.tar.xz
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v38/micro-config-drive-38.tar.xz
...
%prep
%setup -q -n micro-config-drive-38
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569259049
