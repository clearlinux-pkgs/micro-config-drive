...
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v33/micro-config-drive-33.tar.xz
...
%prep
%setup -q -n micro-config-drive-33
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1536251531
