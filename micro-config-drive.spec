...
Version  : 28
Release  : 5
URL      : https://github.com/clearlinux/micro-config-drive/releases/download/v28/micro-config-drive-28.tar.xz
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v28/micro-config-drive-28.tar.xz
...
%prep
%setup -q -n micro-config-drive-28
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1494032728
