...
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v43/micro-config-drive-43.tar.xz
...
%prep
%setup -q -n micro-config-drive-43
cd %{_builddir}/micro-config-drive-43
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573059980
...
cp %{_builddir}/micro-config-drive-43/COPYING %{buildroot}/usr/share/package-licenses/micro-config-drive/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/micro-config-drive-43/LICENSE %{buildroot}/usr/share/package-licenses/micro-config-drive/b5e5f8134b8651d53d5804bb982b9eb4217611c4
%make_install
...
/usr/lib/systemd/system/ucd-aliyun.service
/usr/lib/systemd/system/ucd-aws.service
/usr/lib/systemd/system/ucd-oci.service
/usr/lib/systemd/system/ucd-tencent.service
