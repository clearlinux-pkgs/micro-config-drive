...
Version  : 35
Release  : 22
URL      : https://github.com/clearlinux/micro-config-drive/releases/download/v35/micro-config-drive-35.tar.xz
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v35/micro-config-drive-35.tar.xz
...
%prep
%setup -q -n micro-config-drive-35
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1542394948
