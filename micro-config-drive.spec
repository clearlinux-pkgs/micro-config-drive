...
Version  : 29
Release  : 7
URL      : https://github.com/clearlinux/micro-config-drive/releases/download/v29/micro-config-drive-29.tar.xz
Source0  : https://github.com/clearlinux/micro-config-drive/releases/download/v29/micro-config-drive-29.tar.xz
...
%prep
%setup -q -n micro-config-drive-29
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1497288584
